---
title: Family Owned Rental House
description: Beautiful single story home in peaceful Wells Branch. Newly renovated with direct view to Green Belt and walking distance to Katherine Fleischer Park.
...
Beautiful single story home in peaceful Wells Branch. Newly renovated with direct view to Green Belt and walking distance to Katherine Fleischer Park.
...
<script src="https://cdn.jotfor.ms/s/static/89425c60b9a/static/prototype.forms.js" type="text/javascript"></script>
<script src="https://cdn.jotfor.ms/s/static/89425c60b9a/static/jotform.forms.js" type="text/javascript"></script>
<script src="https://cdn.jotfor.ms/s/static/89425c60b9a/js/vendor/maskedinput_5.0.9.min.js" type="text/javascript"></script>
<script src="https://cdn.jotfor.ms/s/static/89425c60b9a/js/punycode-1.4.1.min.js" type="text/javascript" defer></script>
<script src="https://cdn.jotfor.ms/s/umd/89425c60b9a/for-widgets-server.js" type="text/javascript"></script>
<script src="https://cdn.jotfor.ms/s/umd/89425c60b9a/for-sign-form-integration.js" type="text/javascript" defer></script>
<script src="https://cdn.jotfor.ms/s/static/89425c60b9a/js/vendor/smoothscroll.min.js" type="text/javascript"></script>
<script src="https://cdn.jotfor.ms/s/static/89425c60b9a/js/errorNavigation.js" type="text/javascript"></script>
...
if (window.JotForm && JotForm.accessible) $('input_146').setAttribute('tabindex',0);
      JotForm.setCustomHint( 'input_146', 'First Name, Last Name. 35. Partner.' );
...
<link type="text/css" rel="stylesheet" href="https://cdn.jotfor.ms/themes/CSS/5e6b428acc8c4e222d1beb91.css?v=3.3.66388&themeRevisionID=5f7ed99c2c2c7240ba580251"/>
<link type="text/css" rel="stylesheet" href="https://cdn.jotfor.ms/s/static/89425c60b9a/css/styles/payment/payment_styles.css?3.3.66388" />
<link type="text/css" rel="stylesheet" href="https://cdn.jotfor.ms/s/static/89425c60b9a/css/styles/payment/payment_feature.css?3.3.66388" />
...
<form class="jotform-form" onsubmit="return typeof testSubmitFunction !== 'undefined' && testSubmitFunction();" action="https://submit.jotform.com/submit/252985143994169" method="post" name="form_252985143994169" id="252985143994169" accept-charset="utf-8" autocomplete="on"><input type="hidden" name="formID" value="252985143994169" /><input type="hidden" id="JWTContainer" value="" /><input type="hidden" id="cardinalOrderNumber" value="" /><input type="hidden" id="jsExecutionTracker" name="jsExecutionTracker" value="build-date-1761815431885" /><input type="hidden" id="submitSource" name="submitSource" value="unknown" /><input type="hidden" id="submitDate" name="submitDate" value="undefined" /><input type="hidden" id="buildDate" name="buildDate" value="1761815431885" /><input type="hidden" name="uploadServerUrl" value="https://upload.jotform.com/upload" /><input type="hidden" name="eventObserver" value="1" />
  <div role="main" class="form-all">
    <ul class="form-section page-section" role="presentation">
      ...
      <li class="form-line form-line-column form-col-1" data-type="control_radio" id="id_131"><label class="form-label form-label-top" id="label_131" aria-hidden="false"> Would you like to see the house? </label>
        <div id="cid_131" class="form-input-wide" data-layout="full">
          <div class="form-single-column" role="group" aria-labelledby="label_131" data-component="radio"><span class="form-radio-item" style="clear:left"><span class="dragger-item"></span><input aria-describedby="label_131" type="radio" class="form-radio" id="input_131_0" name="q131_wouldYou" value="Yes" /><label id="label_input_131_0" for="input_131_0">Yes</label></span><span class="form-radio-item" style="clear:left"><span class="dragger-item"></span><input aria-describedby="label_131" type="radio" class="form-radio" id="input_131_1" name="q131_wouldYou" value="No" /><label id="label_input_131_1" for="input_131_1">No</label></span></div>
        </div>
      </li>
      <li class="form-line form-line-column form-col-2" data-type="control_datetime" id="id_132"><label class="form-label form-label-top" id="label_132" for="lite_mode_132" aria-hidden="false"> Tentative date of showing </label>
      ...
      <li class="form-line" data-type="control_address" id="id_87" data-compound-hint=",,,,Please Select,,Please Select,"><label class="form-label form-label-top form-label-auto" id="label_87" for="input_87_addr_line1" aria-hidden="false"> Previous Address </label>
      ...
      <li class="form-line form-line-column form-col-1" data-type="control_radio" id="id_88"><label class="form-label form-label-top" id="label_88" aria-hidden="false"> Own or Rent? </label>
        <div id="cid_88" class="form-input-wide" data-layout="full">
          <div class="form-single-column" role="group" aria-labelledby="label_88" data-component="radio"><span class="form-radio-item" style="clear:left"><span class="dragger-item"></span><input aria-describedby="label_88" type="radio" class="form-radio" id="input_88_0" name="q88_ownOr" value="Own" /><label id="label_input_88_0" for="input_88_0">Own</label></span><span class="form-radio-item" style="clear:left"><span class="dragger-item"></span><input aria-describedby="label_88" type="radio" class="form-radio" id="input_88_1" name="q88_ownOr" value="Rent" /><label id="label_input_88_1" for="input_88_1">Rent</label></span></div>
        </div>
      </li>
      ...
      <li class="form-line form-line-column form-col-5" data-type="control_textbox" id="id_101"><label class="form-label form-label-top" id="label_101" for="input_101" aria-hidden="false"> Car(s) </label>
      ...
      <li class="form-line form-line-column form-col-6" data-type="control_textbox" id="id_102"><label class="form-label form-label-top" id="label_102" for="input_102" aria-hidden="false"> Credit(s) </label>
      ...
      <li class="form-line form-line-column form-col-7" data-type="control_textbox" id="id_103"><label class="form-label form-label-top" id="label_103" for="input_103" aria-hidden="false"> Loan(s) </label>
      ...
      <li class="form-line form-line-column form-col-8" data-type="control_textbox" id="id_104"><label class="form-label form-label-top" id="label_104" for="input_104" aria-hidden="false"> Other </label>
      ...
      <li class="form-line" data-type="control_text" id="id_114">
        <div id="cid_114" class="form-input-wide" data-layout="full">
          <div id="text_114" class="form-html" data-component="text" tabindex="-1">
            <p>Besides applicant, list any other adults/children who plan to reside in the apartment. Anyone listed 18 or over who is not a dependent of the applicant must complete a separate rental application, pay a screening free, and sign all documents.</p>
            <p>Add <strong>First Name, Last Name, Age and Relationship</strong> for every occupant, each on a single line in the box below.</p>
          </div>
        </div>
      </li>
      <li class="form-line" data-type="control_textarea" id="id_146"><label class="form-label form-label-top form-label-auto" id="label_146" for="input_146" aria-hidden="false"> First Name, Last Name. Age. Relationship </label>
        <div id="cid_146" class="form-input-wide" data-layout="full"> <textarea id="input_146" class="form-textarea" name="q146_firstName" style="width:648px;height:163px" data-component="textarea" aria-labelledby="label_146"></textarea> </div>
      </li>
      ...
      <li class="form-line form-line-column form-col-1 jf-required" data-type="control_checkbox" id="id_39"><label class="form-label form-label-top" id="label_39" for="input_39_0" aria-hidden="false"> Confirm<span class="form-required">*</span> </label>
        <div id="cid_39" class="form-input-wide jf-required" data-layout="full">
          <div class="form-single-column" role="group" aria-labelledby="label_39" data-component="checkbox"><span class="form-checkbox-item" style="clear:left"><span class="dragger-item"></span><input aria-describedby="label_39" type="checkbox" class="form-checkbox validate[required]" id="input_39_0" name="q39_name39[]" required="" value="I Agree" /><label id="label_input_39_0" for="input_39_0">I Agree</label></span></div>
        </div>
      </li>
                  ...
                  if (_cFieldFrame)
                  {
                    _cFieldFrame.onload = function()
                    {
                      if (typeof widgetFrameLoaded !== 'undefined')
                      {
                        ...
                        {
                          "formID": 252985143994169
                        }, undefined,
                        {})
                      }
                    };
                    _cFieldFrame.src = "//data-widgets.jotform.io/signature-pad/?qid=142&isOpenedInPortal=undefined&isOpenedInAgent=undefined&align=Left&ref=" +
                      encodeURIComponent(window.location.protocol + "//" + window.location.host) + '&ndt=1' + '' + '&useJotformSign=Yes' +
